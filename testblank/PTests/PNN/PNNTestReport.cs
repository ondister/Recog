...
{
    public class PNNTestReport : RtfPrinter, ITestReport
    {
        ...
        public void Print(bool WaitForExit = false)
        {
            ...
            string filename = _human.secondname.ToString() + "_" + _human.firstname.ToString() + "_" + 
                ...
                _testresult.testdate.Minute.ToString() + GetHashCode().ToString() + "_ПНН.rtf";
            base.CreateDoc(filename);
            base.TypeParagraph(14,Align.Center, "Результаты теста ПНН");
        ...
        private PNNAnswers GetAnswersFromBase()
        {
