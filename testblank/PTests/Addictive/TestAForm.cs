...
{
    public partial class TestAForm : Form
    {
         [System.Runtime.InteropServices.DllImport("user32.dll")]
        private static extern short GetAsyncKeyState(Keys vKey);
         public ATestLoader ktl;
        private pBaseEntities _ge;
        public TestAForm(pBaseEntities Globalentities)
        {
            InitializeComponent();
            _ge = Globalentities;
        }
        ...
        void btn_start_Click(object sender, EventArgs e)
        {
           ...
           this.atc_gone.Dock = DockStyle.Fill;
            ...
            ktl = new ATestLoader(_ge, this.atc_gone);
        ...
        private void TestAdaptabilityForm_Load(object sender, EventArgs e)
        {
            ...
            this.stc_start.AboutTest = "\nВам будут предложены утверждения, касающиеся Вашего характера, на которые Вы должны ответить только «да» ( клавишей 1) или «нет» ( клавишей 2).";
