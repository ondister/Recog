  ...
  public   class TestA:ITest
    {
        ...
        public TestA(pBaseEntities ge, fBaseEntities fe,bool  IsAlone)
        {
            arg = new TestDoneEventArgs();
            _ge = ge;
            _fe = fe;
            _alone = IsAlone;
            tkf = new TestAForm(_ge);
        ...
        {
            AAnswers Answers = tkf.ktl.Answers;
            ...
            testresult t = testresult.Createtestresult(0, _humanid, DateTime.Now, (int)EnumPTests.Addictive, myWriter.ToString(),"auto");
        ...
        {
            AAnswers _answersforbase = new AAnswers(_ge);
            ...
            testresult t = testresult.Createtestresult(0, _humanid, DateTime.Now, (int)EnumPTests.Addictive, myWriter.ToString(), "manual");
            _fe.testresults.AddObject(t);
            _fe.SaveChanges();
