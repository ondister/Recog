...
{
   public class TestKettellC:ITest
    { 
        ...
        public TestKettellC(pBaseEntities ge, fBaseEntities fe,  bool IsAlone)
        {
            arg = new TestDoneEventArgs();
            _ge = ge;
            _fe = fe;
            _alone = IsAlone;
            tkf = new TestKettellCForm(_ge);
        ...
        public void ResultsToBase()
        {
          ...
          XmlSerializer mySerializer = new XmlSerializer(typeof(KettellAnswers));
            ...
            h.testresults.Load();
            testresult t = testresult.Createtestresult(0, _humanid, DateTime.Now, (int)EnumPTests.KettellC, myWriter.ToString(), "auto");
