...
{
    public partial class TestKettellAForm : Form
    {
        [System.Runtime.InteropServices.DllImport("user32.dll")]
        private static extern short GetAsyncKeyState(Keys vKey);
        public KettellATestLoader ktl;
        private pBaseEntities _ge;
        public TestKettellAForm(pBaseEntities Globalentities)
        {
            InitializeComponent();
            _ge = Globalentities;
        }
        ...
        void btn_start_Click(object sender, EventArgs e)
        {
            ...
            ktl = new KettellATestLoader(_ge, this.ktc_gone);
