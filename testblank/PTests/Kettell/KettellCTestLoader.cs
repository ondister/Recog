...
namespace Recog.PTests.Kettell
{
        ...
        public class KettellCTestLoader
    {
            ...
            public KettellCTestLoader(pBaseEntities GlobalEntities, ThreeButtonsControl Control)
            {
                _ge = GlobalEntities;
                _ktc = Control;
        ...
        public void Start()
        {
            testsparam t = _ge.testsparams.First(tp => tp.idt == (int)EnumPTests.KettellC);
