  ...
  public   class TestD:ITest
    {
        ...
        {
            DAnswers _answersforbase = new DAnswers(_ge);
            ...
            testresult t = testresult.Createtestresult(0, _humanid, DateTime.Now, (int)EnumPTests.Adaptability, myWriter.ToString(), "manual");
            _fe.testresults.AddObject(t);
            _fe.SaveChanges();
