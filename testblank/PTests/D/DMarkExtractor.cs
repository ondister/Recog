...
{
    public static class DMarkExtractor
    {
        public static int GetMark(pBaseEntities GlobalEntities, DAnswers FPIAnswers, List<int> AnswersYes, List<int> AnswersNo)
        {
            int m = 0;

            testsparam t = GlobalEntities.testsparams.First(tp => tp.idt == (int)EnumPTests.Adaptability);
