  ...
  public   class TestFPI:ITest
    {
        ...
        public TestFPI(pBaseEntities ge, fBaseEntities fe, bool IsAlone)
        {
            arg = new TestDoneEventArgs();
            _ge = ge;
            _fe=fe;
            _alone = IsAlone;
            tkf = new TestFPIForm(_ge);
        ...
        {
            FPIAnswers Answers = tkf.ktl.Answers;
            ...
            testresult t = testresult.Createtestresult(0, _humanid, DateTime.Now, (int)EnumPTests.FPI, myWriter.ToString(), "auto");
        ...
        {
            FPIAnswers _answersforbase = new FPIAnswers(_ge);
            ...
            testresult t = testresult.Createtestresult(0, _humanid, DateTime.Now, 4, myWriter.ToString(), "manual");
            _fe.testresults.AddObject(t);
            _fe.SaveChanges();
