...
namespace Recog.PTests.MD.Scales
{
    ...
    public class MDScaleM3_1 : IScale
    {
        ...
        public MDScaleM3_1(MDAnswers mdAnswers, pBaseEntities GlobalEntities)
        {
            _answers = mdAnswers;
            _ge = GlobalEntities;
        }
        ...
        {
            get { return "«Критерии параноидного расстройства личности»"; }
        }
        ...
        public void GetMark()
        {
            ...
            _ans = new List<int>() { 16, 24, 46, 71, 96, 116, 132, 138 };
