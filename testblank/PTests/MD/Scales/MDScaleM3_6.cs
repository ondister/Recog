...
namespace Recog.PTests.MD.Scales
{
    ...
    public class MDScaleM3_6 : IScale
    {
        ...
        public MDScaleM3_6(MDAnswers mdAnswers, pBaseEntities GlobalEntities)
        {
            _answers = mdAnswers;
            _ge = GlobalEntities;
        }
        public string Name
        {
            get { return "Агрессивность"; }
        }

        public string Description
        {
            get { return "«Склонность к агрессии»"; }
        }
        ...
        public void GetMark()
        {
            ...
            _ans = new List<int>() { 86, 91, 106, 117, 123 };
