...
namespace Recog.PTests.MD.Scales
{
    ...
    public class MDScaleM3_2 : IScale
    {
        ...
        public MDScaleM3_2(MDAnswers mdAnswers, pBaseEntities GlobalEntities)
        {
            _answers = mdAnswers;
            _ge = GlobalEntities;
        }
        ...
        {
            get { return "«Диссоциальные расстройства личности»"; }
        }
        ...
        public void GetMark()
        {
            ...
            _ans = new List<int>() { 27, 28, 37, 43, 58, 62, 85, 112, 129, 141, 145, 149, 155, 159, 166, 175, 183, 198, 212, 216, 225, 228 };
