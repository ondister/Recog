...
namespace Recog.PTests.MD.Scales
{
    ...
    public class MDScaleM3_4 : IScale
    {
        ...
        public MDScaleM3_4(MDAnswers mdAnswers, pBaseEntities GlobalEntities)
        {
            _answers = mdAnswers;
            _ge = GlobalEntities;
        }
        public string Name
        {
            get { return "Акцентуации"; }
        }

        public string Description
        {
            get { return "«Циклотимическая и неуравновешенная акцентуация»"; }
        }
        ...
        public void GetMark()
        {
            ...
            _ans = new List<int>() { 2, 8, 20, 26, 31, 38, 42, 47, 51, 56 };
