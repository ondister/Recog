...
namespace Recog.PTests.MD.Scales
{
    ...
    public class MDScaleM2_1 : IScale
    {
        ...
        public MDScaleM2_1(MDAnswers mdAnswers, pBaseEntities GlobalEntities)
        {
            _answers = mdAnswers;
            _ge = GlobalEntities;
        }
        ...
        {
            get { return "«Тревожно-фобические и другие тревожные расстройства»"; }
        }
        ...
        public void GetMark()
        {
            ...
            _ans = new List<int>() { 124, 131, 150, 152, 161, 163, 164, 170, 172, 177, 182, 186, 188, 191, 196, 199, 204, 223, 229, 230 };
