...
namespace Recog.PTests.MD.Scales
{
    ...
    public class MDScaleM3_3 : IScale
    {
        ...
        public MDScaleM3_3(MDAnswers mdAnswers, pBaseEntities GlobalEntities)
        {
            _answers = mdAnswers;
            _ge = GlobalEntities;
        }
        ...
        {
            get { return "«Тревожные расстройства личности»"; }
        }
