...
namespace Recog.PTests.MD.Scales
{
    ...
    public class MDScaleM2_2 : IScale
    {
       private double _mark;
        ...
        public MDScaleM2_2(MDAnswers mdAnswers, pBaseEntities GlobalEntities)
        {
            _answers = mdAnswers;
            _ge = GlobalEntities;
        }
        ...
        {
            get { return "«Изолированные фобии»"; }
        }
        ...
        public void GetMark()
        {
            ...
            _ans = new List<int>() { 78, 98, 102, 171, 173, 180, 181, 208, 210, 215, 218 };
